		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				...
				<li class="yui3-u-5-24">
					<a href="list.html" target="_blank"><img src="/images/today01.png" /></a>
				</li>
				<li class="yui3-u-5-24">
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic"><img src="/images/like_02.png" alt="" /></a>
								<div class="like-text">
							...
							<dd>
								<a href="" class="pic"><img src="/images/like_01.png" alt="" /></a>
								<div class="like-text">
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="" class="pic"><img src="/images/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							...
							<dd>
								<a href="" class="pic"><img src="assets/images/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/images/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>捷波朗 </p>
									<p>（jabra）BOOSI劲步</p>
									<h3>¥236.00</h3>
							...
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/images/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>欧普</p>
									<p>JYLZ08面板灯平板灯铝</p>
									<h3>¥456.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/images/like_01.png" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
							...
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img nsrc="assets/images/like_02.png" alt="" /></a>
								<div class="like-text">
		...
		<div class="py-container">
			...
			<div class="clearfix yui3-g Interest">
				...
				<div class="yui3-u row-405 Interest-conver">
					<img src="/images/interest01.png" />
				</div>
				<div class="yui3-u row-225 Interest-conver-split">
					<h5>好东西</h5>
					<img src="/images/interest02.png" />
					<img src="/images/interest03.png" />
				</div>
				<div class="yui3-u row-405 Interest-conver-split blockgary">
					<h5>品牌街</h5>
					<div class="split-bt">
						<img src="/images/interest04.png" />
					</div>
					<div class="x-img fl">
						<img src="/images/interest05.png" />
					</div>
					<div class="x-img fr">
						<img src="/images/interest06.png" />
					</div>
				</div>
				<div class="yui3-u row-165 brandArea">
					<span class="brand-yline"></span>
					<ul class="yui3-g brand-list">
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand01.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand02.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand03.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand04.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand05.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand06.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand07.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand08.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand09.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand10.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand11.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand12.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand13.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/images/brand03.png" /></li>
					</ul>
				</div>
			</div>
	...
	<div class="brand">
		<div class="py-container">
			<ul class="Brand-list blockgary">
				...
				<li class="Brand-item"><img src="/images/brand_03.png" /></li>
				<li class="Brand-item"><img src="/images/brand_05.png" /></li>
				<li class="Brand-item"><img src="/images/brand_07.png" /></li>
				<li class="Brand-item"><img src="/images/brand_09.png" /></li>
				<li class="Brand-item"><img src="/images/brand_11.png" /></li>
				<li class="Brand-item"><img src="/images/brand_13.png" /></li>
				<li class="Brand-item"><img src="/images/brand_15.png" /></li>
				<li class="Brand-item"><img src="/images/brand_17.png" /></li>
				<li class="Brand-item"><img src="/images/brand_19.png" /></li>
			</ul>
		</div>
	</div>
	<!-- 底部栏位 -->
					...
					<div class="tbar-panel-main">
						<div class="tbar-panel-content J-panel-content">
							<div class="jt-history-wrap">
								<ul>
									<!--<li class="jth-item">
										<a href="#" class="img-wrap"> <img src=".portal/images/like_03.png" height="100" width="100" /> </a>
										<a class="add-cart-button" href="#" target="_blank">加入购物车</a>
										<a href="#" target="_blank" class="price">￥498.00</a>
									</li>
									<li class="jth-item">
										<a href="#" class="img-wrap"> <img src="portal/images/like_02.png" height="100" width="100" /></a>
										<a class="add-cart-button" href="#" target="_blank">加入购物车</a>
										<a href="#" target="_blank" class="price">￥498.00</a>
									</li>-->
								</ul>
