...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			<h3>注册新用户<span class="go">我有账号，去<a href="{{route('home_login')}}">登陆</a></span></h3>
			<div class="info">
				<form action="{{route('home_doregister')}}" class="sui-form form-horizontal" method="post">
					{{csrf_field()}}
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							@if($errors->has('mobile_code'))
								<span class="errors">{{$errors->first('mobile_code')}}</span>
							@endif
							<br><br>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="protocol" type="checkbox"><span>同意协议并注册《品优购用户协议》</span>
							@if($errors->has('protocol'))
								<span class="errors">{{$errors->first('protocol')}}</span>
							@endif
						</div>
					</div>
					<div class="control-group">
