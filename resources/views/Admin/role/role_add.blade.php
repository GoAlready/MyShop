...
<body>
	...
	<form action="{{route('admin_roleadd')}}" method="post">
	@csrf
		<div class="left_Competence_add">
			...
			<div class="Competence_add">
				...
				<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色描述 </label>
					<div class="col-sm-9"><textarea name="descript" class="form-control" id="form_textarea" placeholder="" onkeyup="checkLength(this);"></textarea></div>
				</div>
		...
		<div class="Assign_style">
			...
			<div class="Select_Competence">
				...
				<dl class="permission-list">					
					<dt><label class="middle"><input name="pri_id[]" class="ace" type="checkbox" value="{{$v['id']}}" id="id-disable-check"><span
							 class="lbl">{{$v['pri_name']}}</span></label></dt>
					@foreach($v['level'] as $k)
					<dd>
						<dl class="cl permission-list2">
							<dt><label class="middle"><input type="checkbox" class="ace" name="pri_id[]" value="{{$k['id']}}" id="id-disable-check"><span class="lbl">{{$k['pri_name']}}</span></label></dt>
							<dd>
